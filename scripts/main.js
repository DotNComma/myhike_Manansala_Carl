...
//-----------------------------------------------------------------------------
// This function updates the bookmark icon whenever the user clicks it.
// It will add the hike to the "bookmarks" array if it isn't already there,
// but if there is, it will remove it from the "bookmarks" array.
// This will update the icon accordingly
//-----------------------------------------------------------------------------
function updateBookmark(hikeDocID) {
    currentUser.get().then(doc => {
        ...
        .then(function() {
            ...
            .then(function() {
                console.log("This bookmark has been saved for " + hikeDocID)
                let iconID = 'save-' + hikeDocID;
                document.getElementById(iconID).innerText = "bookmark";
            })
        }
